...
public class User {
	...
	public User(Integer user_id, String user_uid, String user_nickname,
			String user_realname, String user_banji, String user_cash,
			String user_reg_type, String user_stop_time, String user_sex,
			String user_head_image, String user_filename,
			String user_phonenumber, String user_password,
			Set<Order> user_setOrders) {
		super();
